...
for sea_depth_index in sea_depth:
    ...
    FOWT_Spar_def = FOWT_Spar(tot_mass=8066048,hub_height=90,msl_to_bottom=120,msl_to_CB=62,
                                  ...
                                  msl_to_fairlead=70,mooring_line_length=902.2,radius_to_anchor=853.87,sea_depth= sea_depth_index ,
    ...
    save_results(results, f'./results/Parametric_Analysis/Sea_depth/{sea_depth_index}.pkl')
